...
SELECTION_MODES = ['KEEP_ALL', 'QUALITY_BEST05','QUALITY_BEST10', 'QUALITY_BEST15', 'QUALITY_BEST20', 'QUALITY_BEST20','QUALITY_BEST30', 'QUALITY_BEST40', 'QUALITY_BEST50','QUALITY_BEST60']
HASHING_MODES = ['HASH_ALL', 'HASH_GEOM_RFDD', 'HASH_GEOM', 'HASH_RFDD']
